...
import {
  ...
  Item,
  criaCarrinho,
} from '../src/componentes/criaCarrinho.js';
...
if (ordemCompra.success) {
  console.log(
    'Usuario:',
    ordemCompra.compra!.idUsuario,
    '\n',
    'Forma Pagamento:',
    ordemCompra.compra!.formaPagamento,
    '\n',
    'Data da Compra:',
    ordemCompra.compra!.dataCompra.toLocaleDateString('pt-br', {
      weekday: 'long',
      day: '2-digit',
      month: '2-digit',
      year: 'numeric',
    ...
    '\n',
    'Numero de Parcelas:',
    ordemCompra.compra!.parcelas,
    '\n',
    'Valor da Parcela:',
    ordemCompra.compra!.valorParcela.toLocaleString('pt-br', {
      style: 'currency',
      currency: 'BRL',
    }),
    '\n',
    'Valor Total da Compra:',
    ordemCompra.compra!.total.toLocaleString('pt-br', {
      style: 'currency',
      currency: 'BRL',
    }),
    '\n',
