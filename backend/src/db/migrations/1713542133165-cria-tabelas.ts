...
export class CriaTabelas1713542133165 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "livros" ("isbn" character varying(100) NOT NULL, "titulo" character varying(50) NOT NULL, "resumo" character varying(500) NOT NULL, "sumario" character varying(500) NOT NULL, "preco" numeric(12,2) NOT NULL, "num_pagina" integer NOT NULL, "data" date NOT NULL, "categoriaIdSlug" character varying(100), "autorId" uuid, CONSTRAINT "REL_647dc3b0988823d5c373b02466" UNIQUE ("categoriaIdSlug"), CONSTRAINT "PK_af619d4f3297f10337117d0738f" PRIMARY KEY ("isbn"))`,
    );
    await queryRunner.query(
      `CREATE TABLE "usuarios" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "nome" character varying(100) NOT NULL, "email" character varying(150) NOT NULL, "telefone" character varying(15) NOT NULL, "cpf" character varying(11) NOT NULL, "country" character varying(3) NOT NULL, "estado" character varying(2) NOT NULL, "cidade" character varying(30) NOT NULL, "bairro" character varying(30) NOT NULL, "endereco" character varying(150) NOT NULL, "number" integer, "complemento" character varying(70), "cep" character varying(10), CONSTRAINT "PK_d7281c63c176e152e4c531594a8" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
